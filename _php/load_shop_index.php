...
?>
<div class="row-pull">
    <ul class="new-product-scroll" name="0" id="new-shop-scroll">
        <?php
...
<a class="left carousel-control" href="#myCarousel" data-slide="prev" onclick="left_shop_product()"><i class="glyphicon glyphicon-chevron-left"></i></a>
<a class="right carousel-control" href="#myCarousel" data-slide="next" onclick="right_shop_product()"><i class="glyphicon glyphicon-chevron-right"></i></a>