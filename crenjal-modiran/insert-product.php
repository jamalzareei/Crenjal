                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="form-horizontal" id="default">
                                                    <fieldset title=" اضافه کردن محصول جدید" class="step" id="default-step-0">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4"><input placeholder="کد کالا" class="form-control text-right" type="text" id="code_product"></div>
                                                            <div class="col-md-4"><input placeholder="نام فارسی کالا" class="form-control text-right" type="text" id="name_product_fa"></div>
                                                            <div class="col-md-4"><input placeholder="نام انگلیسی کالا" class="form-control text-right" type="text" id="name_product_en"></div>
                                                            <hr><br>
                                                            <div class="col-md-4"><input placeholder="رنگهای کالا (سفید،قهوه ای) با کاما جدا کن" class="form-control text-right" type="text" id="color_product"></div>
                                                            <div class="col-md-4"><input placeholder="تعداد" class="form-control text-right" type="text" id="num_product"></div>
                                                            <div class="col-md-2">
                                                                <label class="label_check c_on" for="vizhe_product">
                                                                    <input name="sample-checkbox-01" value="1" checked="" type="checkbox" id="vizhe_product">
                                                                    ویژه
                                                                </label>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <!--<label class="label_check c_off" for="checkbox-02">
                                                                    <input name="sample-checkbox-02" id="checkbox-02" value="1" type="checkbox" id="slide_product">
                                                                    اسلاید شو
                                                                </label>-->
                                                            </div>
                                                            <hr><br>
                                                            <div class="col-md-4">
                                                                <select id="sex_product" style="width: 100%">
                                                                    <option value="خانم">خانم</option>
                                                                    <option value="آقا">آقا</option>
                                                                </select>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <select id="group_product" style="width: 100%">
                                                                    <option value="پوشاک">پوشاک</option>
                                                                    <option value="زیورآلات">زیورآلات</option>
                                                                    <option value="دکوراتیو">دکوراتیو</option>
                                                                    <option value="کیف و کمر بند">کیف و کمر بند</option>
                                                                </select>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <select id="gender_product" style="width: 100%">
                                                                    <option value="پارچه">پارچه</option>
                                                                    <option value="چرم">چرم</option>
                                                                    <option value="مس و برنز">مس و برنز</option>
                                                                    <option value="کاشی و سرامیک">کاشی و سرامیک</option>
                                                                    <option value="چوب">چوب</option>
                                                                </select>                                                                
                                                            </div>
                                                            <hr><br>
                                                            <div class="col-md-6"><input placeholder="قیمت اصلی" class="form-control text-right" type="text" id="price_main_product"></div>
                                                            <div class="col-md-6"><input placeholder="قیمت تخفیف" class="form-control text-right" type="text" id="price_takhfif_product"></div>
                                                            <hr><br>
                                                            <script>
                                                            ...
                                                            <form method="post" enctype="multipart/form-data">
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <progress class="pull-left" id="prog" min="0" max="100" ></progress>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4 pull-left">
                                                                <button type="button" class="btn btn-primary pull-left" id="insert-data" onclick="insert_product()">ثبت اولیه کالا برای دریافت ای دی کلیک کنید</button>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12" id="upload-gallery">
                                                                <form method="post" enctype="multipart/form-data">
                                                                    <div class="col-md-4"><input type="file" name="fileToUpload_gallery" id="fileToUpload_gallery" multiple="multiple"
                                                                                                 onchange="fileSelected_gallery();" /></div>
